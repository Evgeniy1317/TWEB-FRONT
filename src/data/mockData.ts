...
const productsSeed: Product[] = [
  ...
  {
    id: 13,
    title: 'Обмотка Yonex Super Grap, чёрная',
    price: 180,
    category: 'grips',
    condition: 'new',
  ...
  {
    id: 14,
    title: 'Кинезио-тейп 5 см × 5 м, бандаж на запястье',
    price: 420,
  ...
  {
    id: 15,
    title: 'Носки спортивные средней высоты',
    price: 150,
    category: 'socks',
    condition: 'new',
  ...
  {
    id: 16,
    title: 'Сетка бадминтонная с тросами',
    price: 890,
  ...
  {
    id: 17,
    title: 'Конус разметочный, комплект 10 шт.',
    price: 350,
  ...
  {
    id: 18,
    title: 'Разное: держатель для телефона на сетку',
    price: 95,
    category: 'other',
    condition: 'new',
