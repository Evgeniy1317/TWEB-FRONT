...
const LOGO_VICTOR = '/media/images/Logo-300x300.png';
const LOGO_ALTIUS = '/media/images/449785420_10212023391816179_7793559525705666038_n.jpg';
const LOGO_DTM = '/media/images/6cf87f30-c1b2-4543-99a7-137e10d1a76f.jpg';
const LOGO_USMF = '/media/images/i%20(1).webp';
const LOGO_VALEA = '/media/images/i%20(2).webp';

const COVER_DTM = '/media/images/5377695244310221422.jpg';
const COVER_VICTOR = '/media/images/483367037_1218244436879199_1759370186017822007_n.jpg';
const COVER_ALTIUS = '/media/images/486142766_1049927993827861_4689185326898161056_n.jpg';
const COVER_CSU_USMF = '/media/images/2ef05ccf2e1b7901431c5efe7ecc5497.jpg';
const COVER_VALEA = '/media/images/dolina_roz_avgust.jpg';
const COVER_USMF_TESTEMITANU = '/media/images/DSC_2575.jpg.jpeg';
